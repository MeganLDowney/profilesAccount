...
$user = "megan_megan"; //Your database username Does not change
$pass = "@Lbcc2023!"; // Your database user password
$db = "megan_cosw30_finalweeks"; //Your database name you want to connect to - add your number to the end of this
